...
class PaginationHelperTest {
    ...
    void testPageCount() {
        ...
        assertThat(helper.pageCount()).isEqualTo(6);
    }
    ...
    void testPageItemCount() {
        ...
        assertEquals(-1, helper.pageItemCount(-1), "pageItemCount is returning incorrect value for page 2");

    }

    @Test
    @Order(4) @DisplayName("Test pageIndex()")
    void testPageIndex() {
        ...
        helper = new PaginationHelper<>(collection, 1);
        assertEquals(5, helper.pageIndex(5), "pageIndex is returning incorrect value for index -10");
    }
